...
\begin{itemize}
    ...
    \item Store the new value in the same register an returns the execution to the original program.
\end{itemize} 
Instructions instrumented are only Floating point arithmetic instructions inside the main executable.
